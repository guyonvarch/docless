package com.dividat.docless.schema

import com.dividat.docless.schema.JsonSchema.NamedDefinition
import com.dividat.docless.swagger.Responses.Response
import io.circe._
...
object JsonSchema
  ...
  def tagId[A](tag: ru.WeakTypeTag[A]): String =
    tag.tpe.typeSymbol.name.toString +
